...
title(strcat('Odpowiedü obiektu na wymuszenie skokowe dla T =',num2str(T9(i))))
...
title(strcat('Odpowiedü uk≥adu z regulatorem na wymuszenie skokowe dla T =',num2str(T9(i))))
grid on
end